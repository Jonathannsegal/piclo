...
const GOOGLE_SHEETS_URL = "https://script.google.com/macros/s/AKfycbzO8m8UaiIWIHr25ukc14cMiCLhvbksxV8511ZXvqZorb-tvL0Ode2ePgAEkWPISZIz0w/exec";
...
export async function POST(request: Request) {
    try {
        ...
        const cleanedData = {
            ...
            travelMethod: Array.isArray(body.travelMethod) ? body.travelMethod.join(', ') : body.travelMethod,
            travelerType: Array.isArray(body.travelerType) ? body.travelerType.join(', ') : body.travelerType,
            destinationType: Array.isArray(body.destinationType) ? body.destinationType.join(', ') : body.destinationType,
            sharingMethod: Array.isArray(body.sharingMethod) ? body.sharingMethod.join(', ') : body.sharingMethod
        };
        ...
        console.log('[API Route] Google Sheets response headers:',
        ...
        try {
            ...
            throw new Error(`Invalid JSON response from Google Sheets: ${responseText.substring(0, 100)
                }...`);
        }
